level_0 = {
		...
		'bg_dec': './levels/0/level_0_bg_decorations.csv',
        'bg_dec2': './levels/0/level_0_bg_decorations2.csv',
        'bg_dec3': './levels/0/level_0_bg_decorations3.csv',
        'bg_dec4': './levels/0/level_0_bg_decorations4.csv',
        'bg': './levels/0/level_0_bg_bg.csv',
		'node_pos': (110,400),
		'unlock': 1,
...
level_1 = {
		...
		'bg_dec': './levels/1/level_1_bg_decorations.csv',
        'bg_dec2': './levels/1/level_1_bg_decorations2.csv',
